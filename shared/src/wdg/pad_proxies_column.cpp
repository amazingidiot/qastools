...
void
Pad_Proxies_Column::set_column_index (
	unsigned int idx_n )
{
	_column_index = idx_n;
}
...
void
Pad_Proxies_Column::set_slider_proxy (
...
void
Pad_Proxies_Column::set_switch_proxy (
...
void
Pad_Proxies_Column::set_enum_proxy (
...
void
Pad_Proxies_Column::set_show_value_string (
	bool flag_n )
{
