...
inline
const Equal_Columns_Layout_Group *
Equal_Columns_Layout::active_group (
	unsigned int idx_n ) const
{
...
inline
unsigned int
Equal_Columns_Layout::row_height (
	unsigned int idx_n ) const
{
...
inline
unsigned int
Equal_Columns_Layout::row_min_height (
	unsigned int idx_n ) const
{
...
inline
unsigned int
Equal_Columns_Layout::col_type_width (
	unsigned int type_n )
{
