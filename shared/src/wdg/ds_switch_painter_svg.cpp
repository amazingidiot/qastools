...
void
DS_Switch_Painter_SVG::set_base_dir (
	const QString & dir_n )
{
	_base_dir = dir_n;
}
...
void
DS_Switch_Painter_SVG::set_file_prefix_bg (
...
void
DS_Switch_Painter_SVG::set_file_prefix_handle (
	const QString & file_prefix_n )
{
...
bool
DS_Switch_Painter_SVG::file_ready (
	const QString & file_name_n ) const
{
...
int
DS_Switch_Painter_SVG::paint_image (
	::dpe::Paint_Job * pjob_n )
{
	int res ( 0 );

	res = create_image_data (
		&pjob_n->img_set->image ( pjob_n->img_idx ),
		pjob_n->meta );
...
int
DS_Switch_Painter_SVG::paint_bg (
	::dpe::Paint_Job * pjob_n ) const
{
	const QString fname (
		file_name ( _prefix_bg, _suffix_bg[pjob_n->img_idx] ) );

	return render_svg (
		pjob_n->img_set->image ( pjob_n->img_idx ), fname );
}


int
DS_Switch_Painter_SVG::paint_handle (
	::dpe::Paint_Job * pjob_n ) const
{
	const QString fname (
...
QString
DS_Switch_Painter_SVG::file_name (
	const QString & prefix_n,
...
int
DS_Switch_Painter_SVG::render_svg (
	::dpe::Image & img_n,
