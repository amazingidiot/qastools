...
DS_Imaging::DS_Imaging (
	unsigned int num_image_groups_n,
...
void
DS_Imaging::set_images_variant_id (
...
void
DS_Imaging::set_images_style_id (
...
void
DS_Imaging::set_images_style_sub_id (
	unsigned int style_n )
{
	for ( unsigned int ii=0; ii < image_request()->meta.size() ; ++ii ) {
