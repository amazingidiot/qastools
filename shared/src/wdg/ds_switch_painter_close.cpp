...
int
DS_Switch_Painter_Close::paint_image (
...
int
DS_Switch_Painter_Close::paint_bg (
	::dpe::Paint_Job * pjob_n,
	PData & pd )
{
	// Calc state flags
...
void
DS_Switch_Painter_Close::paint_bg_area (
	PData & pd )
{
	{
...
void
DS_Switch_Painter_Close::paint_bg_border (
	PData & pd )
{
	// Border
	{
...
int
DS_Switch_Painter_Close::paint_handle (
	::dpe::Paint_Job * pjob_n,
	PData & pd )
{
	// Calc state flags
...
void
DS_Switch_Painter_Close::paint_handle_area (
	PData & pd )
{
	QColor col_full;
	...
	pd.qpnt->rotate ( 45 );
	pd.qpnt->drawRect ( QRectF (
		-rwidth / 2.0, -rheight / 2.0,
		rwidth, rheight ) );
	pd.qpnt->drawRect ( QRectF (
		-rheight / 2.0, -rwidth / 2.0,
		rheight, rwidth ) );
...
void
DS_Switch_Painter_Close::paint_focus_path (
	PData & pd )
{
