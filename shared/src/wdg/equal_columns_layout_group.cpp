...
//
Equal_Columns_Layout_Row::Equal_Columns_Layout_Row (
...
void
Equal_Columns_Layout_Column::set_column_pos (
	unsigned int pos_n )
{
	_column_pos = pos_n;
}
...
void
Equal_Columns_Layout_Column::set_column_width (
...
void
Equal_Columns_Layout_Column::append_row (
...
void
Equal_Columns_Layout_Group::set_group_pos (
	unsigned int pos_n )
{
	_group_pos = pos_n;
}
...
void
Equal_Columns_Layout_Group::set_group_width (
	unsigned int width_n )
{
