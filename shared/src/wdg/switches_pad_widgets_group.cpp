...
void
Switches_Pad_Widgets_Group::set_label (
	QLabel * wdg_n )
{
	if ( _label != 0 ) {
		delete _label;
...
void
Switches_Pad_Widgets_Group::append_widgets (
	Switches_Pad_Widgets * spw_n )
{
	if ( spw_n == 0 ) {
		return;
	}
...
bool
Switches_Pad_Widgets_Group::eventFilter (
	QObject * watched_n,
	QEvent * event_n )
{
	bool res ( false );
...
void
Switches_Pad_Widgets_Group::paintEvent (
	QPaintEvent * event_n )
{
