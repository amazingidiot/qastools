...
int
DS_Slider_Painter_Bevelled::paint_image (
...
int
DS_Slider_Painter_Bevelled::paint_bg (
	::dpe::Paint_Job * pjob_n,
	PData & pd )
{
...
void
DS_Slider_Painter_Bevelled::paint_bg_area (
	PData & pd )
{
	...
	// Fake 3D gradient
	{
		QLinearGradient lgrad (
			QPointF ( x_start, 0.0 ), QPointF ( x_end, 0.0 ) );
	...
	// Sound color overlay
	{
		...
		QLinearGradient lgrad (
			QPointF ( x_start, 0.0 ), QPointF ( x_start + inner_width / 7.0, 0.0 ) );
...
void
DS_Slider_Painter_Bevelled::paint_bg_frame (
	PData & pd )
{
	QColor fcol;
	{
...
void
DS_Slider_Painter_Bevelled::paint_bg_area_deco (
	PData & pd )
{
	QPainterPath ppath;
...
void
DS_Slider_Painter_Bevelled::paint_bg_ticks (
	PData & pd )
{
	const int range_max_idx ( pd.meta_bg->ticks_range_max_idx );
...
void
DS_Slider_Painter_Bevelled::paint_bg_tick (
	PData & pd,
	double tick_pos_n,
	double tick_width_n,
	const QColor & col_n )
...
int
DS_Slider_Painter_Bevelled::paint_marker (
	::dpe::Paint_Job * pjob_n,
	PData & pd )
{
	int res ( 0 );
...
void
DS_Slider_Painter_Bevelled::paint_marker_current (
	PData & pd )
{
...
void
DS_Slider_Painter_Bevelled::paint_marker_hint (
	PData & pd )
{
	int bevel ( pd.width() / 3 );
	bevel = qMax ( bevel, 2 );
...
int
DS_Slider_Painter_Bevelled::paint_frame (
	::dpe::Paint_Job * pjob_n,
	PData & pd )
{
...
void
DS_Slider_Painter_Bevelled::paint_frame_deco (
	PData & pd )
{
...
int
DS_Slider_Painter_Bevelled::paint_handle (
	::dpe::Paint_Job * pjob_n,
	PData & pd )
{
	pd.bw = pd.width() / 24;
...
void
DS_Slider_Painter_Bevelled::paint_handle_area (
	PData & pd )
{
...
void
DS_Slider_Painter_Bevelled::paint_handle_frame (
	PData & pd )
{
	QColor col;
	{
...
void
DS_Slider_Painter_Bevelled::paint_handle_items (
	PData & pd )
{
	// Colors
...
void
DS_Slider_Painter_Bevelled::papp_bevel_area (
	QPainterPath & ppath_n,
	const QRectF & area_n,
	double bevel_n,
	double indent_n )
{
	...
	ppath_n.lineTo ( xl[0] + ds, yl[1] - db ),
	ppath_n.closeSubpath();
}


void
DS_Slider_Painter_Bevelled::paint_bevel_raised_frame (
	PData & pd,
	const QRectF & area_n,
	double bevel_n,
	...
	const QColor & col_n )
{
	...
	// Bright area
	{
		...
		papp_bevel_frame_corner ( pp, area_n, 0, bevel_n, edge_width_n, shrink_out );
	...
	{
		QPainterPath pp;
		papp_bevel_frame_corner ( pp, area_n, 1, bevel_n, edge_width_n, shrink_out );
...
QPainterPath
DS_Slider_Painter_Bevelled::path_bevel_frame (
	const QRectF & area_n,
	double bevel_n,
	double frame_width_n,
	double indent_n )
...
void
DS_Slider_Painter_Bevelled::papp_bevel_frame_corner (
	QPainterPath & ppath_n,
	const QRectF & area_n,
	unsigned int edge_n,
	double bevel_n,
...
void
DS_Slider_Painter_Bevelled::papp_bevel_frame_edge (
	QPainterPath & ppath_n,
	const QRectF & area_n,
	unsigned int edge_n,
	double bevel_n,
