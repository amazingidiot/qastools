...
{
	{
		QString cstyle ( "style=\"padding-left: 0px; padding-right: %1px; padding-top: 0px; padding-bottom: %2px;\" align=\"left\"" );
...
void
Message_Widget::set_mixer_open_fail (
