...
void
Image_Allocator::set_multithread (
	bool flag_n )
{
...
void
Image_Allocator::process_handle (
...
void
Image_Allocator::enqueue_handle (
	::dpe::IS_Buffer_Handle * handle_n )
{
