...
void
Mixer_HCTL_Int_Proxy_Slider::set_joined (
	bool flag_n )
{
	_is_joined = flag_n;
}
...
void
Mixer_HCTL_Int_Proxy_Slider::set_integer_value (
	long value_n )
{
...
{
	//::std::cout << "Mixer_HCTL_Int_Proxy_Slider::integer_value_changed " << integer_value() << "\n";
...
{
	//::std::cout << "Mixer_HCTL_Int_Proxy_Slider::slider_index_changed " << integer_index() << "\n";
