...
void
Mixer_HCTL_Editor::set_inputs_setup (
...
QGridLayout *
Mixer_HCTL_Editor::create_channel_grid (
	...
	bool bold_labels_n )
{
	...
	for ( unsigned int cii=0; cii < num; ++cii ) {
		...
		wdg_label->setToolTip ( editor_data()->ttip_grid_lbl_channel.arg ( str_idx ) );
