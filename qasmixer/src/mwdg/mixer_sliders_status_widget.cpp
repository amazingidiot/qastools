...
Mixer_Sliders_Status_Widget::Mixer_Sliders_Status_Widget ( QWidget * parent_n )
...
void
Mixer_Sliders_Status_Widget::select_slider ( unsigned int grp_idx_n,
    ...
    ::MWdg::Mixer_Sliders_Proxy_Slider * proxy_n )
{
  ...
  if ( _proxy_slider != proxy_n ) {
    ...
    if ( _proxy_slider != 0 ) {
      if ( _proxy_slider->mixer_simple_elem () != 0 ) {
        connect ( _proxy_slider->mixer_simple_elem (),
...
void
Mixer_Sliders_Status_Widget::elem_set_volume ( long value_n ) const
{
  if ( _proxy_slider != 0 ) {
...
void
Mixer_Sliders_Status_Widget::elem_set_nearest_dB ( long dB_value_n ) const
{
  if ( _proxy_slider != 0 ) {
