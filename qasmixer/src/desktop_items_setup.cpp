...
Desktop_Items_Setup::read_from_storage ( )
{
	...
	tray_show_icon = settings.value ( "tray_show_icon",
	...
	// Tray mixer
	{
		...
		dsetup.device_mode = settings.value ( "device_mode",
			dsetup.device_mode ).toInt();

		dsetup.user_device = settings.value ( "user_device",
		...
		vsetup.show_balloon = settings.value ( "show_balloon",
			vsetup.show_balloon ).toBool();

		vsetup.balloon_lifetime = settings.value ( "balloon_lifetime",
...
Desktop_Items_Setup::write_to_storage ( )
{
	...
	settings.setValue ( "start_device_mode",
		start_device_mode );

	settings.setValue ( "start_user_device",
		start_user_device );
	...
	settings.setValue ( "tray_show_icon",
		tray_show_icon );
	...
	// Mini mixer
	{
		...
		settings.setValue ( "device_mode",
			dsetup.device_mode );

		settings.setValue ( "user_device",
			dsetup.user_device );
		...
		settings.setValue ( "show_balloon",
			vsetup.show_balloon );

		settings.setValue ( "balloon_lifetime",
